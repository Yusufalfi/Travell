...
<main>
    <section class="section-details-header"></section>
      <section class="section-details-content">
         <div class="container">
           <div class="row">
             <div class="col-lg-8 col-sm-8 pl-lg-0">
               <nav>
                 <ol class="breadcrumb">
                ...
                <h1> {{$item->title}}</h1>
                 ...
                 <div class="features row">
                   <div class="col-md-4">
                     ...
                     <img src="{{url('frontend/images/ic- event.png')}}" alt="" class="features-image float-left">
                     <div class="description">
                   ...
                   <div class="col-md-4 border-left" >
                       <div class="description">
                       <img src="{{url('frontend/images/ic- language.png')}}" alt="" class="features-image float-left">
                         <div class="description">
                             <h3>language</h3>
                             <p>{{$item->language}}</p>
                         </div>
                     ...
                     <div class="col-md-4 border-left">
                         <div class="description">
                         <img src="{{url('frontend/images/ic- foods.png')}}" alt="" class="features-image float-left">
                           <div class="description">
                               <h3>Foods</h3>
                               <p>{{$item->foods}}</p>
                           </div>
